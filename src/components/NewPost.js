  ...
  return (
    <main className="NewPost">
      ...
      ></textarea> */}
        ...
        <label htmlFor="category" className="form-label text-dark fs-5">
          Category:
        </label>
        <select
          id="category"
        ...
        <label
          htmlFor="fileInput"
          className="form-label form-control text-dark fs-5"
          style={{
        ...
        <div>
          {filename ? (
            <p className="text-center text-dark">
              {" "}
              <span className="h6">Selected File</span>: {filename}
            </p>
          ) : (
